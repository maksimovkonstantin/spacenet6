...
load_from = '/wdata/segmentation_logs/baseline_hardaugs_1_unet_resnet34/checkpoints/best.pth'
...
train_augs = albu.Compose([albu.OneOf([albu.RandomCrop(crop_size[0], crop_size[1], p=1.0),
                           ...
                           albu.ShiftScaleRotate(shift_limit=0.0, scale_limit=0.1, rotate_limit=10, p=augs_p),
                           albu.GaussNoise(var_limit=(0, 10), p=augs_p),
                           albu.OneOf([albu.GaussianBlur(blur_limit=5, p=augs_p),
                                       albu.MedianBlur(blur_limit=5, p=augs_p),
                                       albu.MotionBlur(blur_limit=5, p=augs_p)]),
                           albu.CoarseDropout(p=augs_p),
                           albu.ChannelDropout(p=augs_p)
                           ], p=augs_p)
